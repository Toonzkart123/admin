                ...
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <span className={`px-2 py-1 text-xs leading-5 font-semibold rounded-full ${getStatusBadgeClass(selectedOrder.status)}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <h4 className="text-sm font-medium text-gray-500 mt-4 mb-2">Customer Information</h4>
                        <div className="bg-gray-50 p-4 rounded-md">
                      ...
                      <div>
                        ...
                        <h4 className="text-sm font-medium text-gray-500 mt-4 mb-2">Update Status</h4>
                        <div className="flex flex-wrap gap-2">
                          <button 
                    ...
                    <h4 className="text-sm font-medium text-gray-500 mt-6 mb-2">Order Items</h4>
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                          <tr>
